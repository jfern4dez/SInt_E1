# =========================================================================
# Main Script: 8-PUZZLE
# =========================================================================
# Solves a specific 8-Puzzle instance and exports results.
# -------------------------------------------------------------------------
#
# Authors / Maintainers:
#   - Roberto Carballedo
...
# 6. Run Specific Instance (6 steps to solution)
solve.instance(initial_state = c(1, 2, 5, 
                                 3, 4, 8, 
                                 0, 6, 7))
