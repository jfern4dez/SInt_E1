# =========================================================================
# Main Script: ONE PIZZA (incremental)
# =========================================================================
# Solves One Pizza instances loaded from text files.
# -------------------------------------------------------------------------
#
# Authors / Maintainers:
#   - Roberto Carballedo
...
files <- c("../data/one-pizza/spanish.txt")

for (f in files) {
  tryCatch({
    # You can adjust the parameters (like p and random_actions) as needed
    solve.instance(file = f, p = 0.75, random_actions = TRUE)
  }, error = function(e) {
